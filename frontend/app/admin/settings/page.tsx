...
import { Users, FolderGit2, LayoutTemplate, Settings as SettingsIcon, Trophy, Key } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-6 w-full max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link href="/admin/settings/api-keys" className="admin-card p-6 flex flex-col hover:bg-slate-800/40 transition-colors group cursor-pointer border border-slate-800/60 hover:border-purple-500/50">
                    ...
                    <h3 className="text-lg font-medium text-slate-200 mb-2">API Keys</h3>
                    <p className="text-sm text-slate-500 flex-1">
                        Manage API keys for external system integrations and read-only data access.
                    </p>
                </Link>
            </div>
