        ...
        <div className="flex flex-col gap-6 w-full max-w-5xl">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-400">Manage application configuration and user preferences.</p>
                </div>
            </div>
            ...
            <div className="admin-card flex flex-col items-center justify-center py-20 text-slate-500 border-dashed border-2 bg-slate-900/30">
                ...
                <p className="text-sm max-w-md text-center">
                    The administration settings panel is currently under development. Global configuration options will appear here.
                </p>
            </div>
        </div>
    );
